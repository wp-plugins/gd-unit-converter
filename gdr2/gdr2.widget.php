...
if (!class_exists('gdr2_Widget')) {
    class gdr2_Widget extends WP_Widget {
        ...
        function display_select_options($options, $selected = "", $select_name = "", $select_id = "", $class = "", $style = "") {
        ...
        function excerpt($content, $words_count = 16) {
            $text = trim($content);
        ...
        function prepare($instance, $results) { return $results; }

        function results($instance) { return null; }

        function render($results, $instance) { echo $results; }
    }
}
